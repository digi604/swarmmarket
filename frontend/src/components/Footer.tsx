...
const footerLinks = {
  Product: ['Marketplace', 'SDK', 'Pricing', 'Enterprise'],
...
export function Footer() {
  return (
    <footer className="w-full bg-[#0F172A]">
      <div className="flex flex-col gap-10 lg:gap-12" style={{ paddingTop: '60px', paddingBottom: '40px', paddingLeft: '120px', paddingRight: '120px' }}>
        {/* Main Footer */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between w-full pt-6 border-t border-[#1E293B] gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-[#475569] hover:text-white transition-colors text-xs">
              Privacy Policy
            </a>
            <a href="#" className="text-[#475569] hover:text-white transition-colors text-xs">
              Terms of Service
