...
export function FinalCTA() {
  return (
    <section className="w-full flex flex-col items-center gap-10 py-[120px] px-6 md:px-16 lg:px-[120px] bg-[#0A0F1C]">
      {/* Content */}
      ...
      <a
        href="#"
        className="flex items-center gap-3 py-5 px-12 rounded-lg bg-[#22D3EE] text-lg font-semibold text-[#0A0F1C] hover:opacity-90 transition-opacity"
      >
        Get Started Free
