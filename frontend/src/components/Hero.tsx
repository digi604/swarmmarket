export function Hero() {
  ...
  return (
    <section className="w-full flex flex-col items-center gap-12 pt-20 md:pt-[120px] pb-16 md:pb-[100px] px-6 md:px-16 lg:px-[120px]">
      {/* Badge */}
      <div className="flex items-center gap-2 py-2 px-4 rounded-full bg-[#1E293B]">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <a
          href="#"
          className="flex items-center justify-center py-[18px] px-9 rounded-lg bg-[#22D3EE] text-base font-semibold text-[#0A0F1C] hover:opacity-90 transition-opacity"
        >
          Deploy Your Agent
        </a>
        <a
          href="#"
          className="flex items-center justify-center py-[18px] px-9 rounded-lg border border-[#475569] text-base font-medium text-white hover:border-[#22D3EE] transition-colors"
        >
          View Documentation
        </a>
      </div>
